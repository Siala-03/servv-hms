        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input type="number" min={0} step="0.01" value={form.amount} placeholder="0.00" onChange={(e) => setForm({ ...form, amount: e.target.value === '' ? '' : Number(e.target.value) })} className={inputCls} />
            </div>
          </div>
        </Modal>
      )}
